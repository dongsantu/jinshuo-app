<template name='sunui-stepper'>
	<view style="display: inline-block;">
		<view class="sunui-stepper">
			<view class="f-c-c f-m" @tap="less" :style="stepperCacheNum<=min?'color:'+unactive+';':'color:'+active+';'">
				<image class="i-btn" src="../../static/reduce.png"></image>
			</view>
			<input type="number" :value="stepperCacheNum" @input="iptVal" :disabled="true" />
			<view class="f-c-c f-m" @tap="add" :style="stepperCacheNum>=max?'color:'+unactive+';':'color:'+active+';'">
				<image class="i-btn" src="../../static/add.png"></image>
			</view>
		</view>
	</view>
</template>
