<template>
	<view>
		<view class="list" v-if="list.length>0">
			<navigator :url="'/pages/product/detail?id='+item.id+ '&shopId='+$store.state.shopId" class="li-item b-b" v-for="(item,i) in list" :key="i">
				<view class="img">
				...
				<view class="content">
					...
					<view class="f-between-c">
						...
						<view v-else></view>
						<view v-if="item.disMoney" class="buy-btn2 mrg_r10">赚{{item.disMoney}}元</view>
						<view v-else class="buy-btn mrg_r10" >立即抢购</view>
					</view>
